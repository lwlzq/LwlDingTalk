...
namespace Liuweiliang\LwlDingTalk\Event;
...
class DingCallbackCrypto
{
    ...
    public function getEncryptedMapDetail($plain, $timeStamp, $nonce)
    {
        ...
        $ret = $array[0];
        if ($ret != 0) {
            return ['code'=>'412','ErrorCode'=>$ret, 'message' => '1123'];
    ...
    public function getDecryptMsg($signature, $timeStamp = null, $nonce, $encrypt)
    {
        if (strlen($this->m_encodingAesKey) != 43) {
            return ['code'=>'412','ErrorCode'=>ErrorCode::$IllegalAesKey, 'message' => '3333'];
        ...
        if ($result[0] != 0) {
            return ['code'=>'412','ErrorCode'=>$result[0], 'message' => $result[0].'lwl'];
 ...
 * @Class ErrorCode
 * @Description:
 * @CreateDate: 2023/3/4 14:59
 * @UpdateDate: 2023/3/4 14:59 By 小刘
 *
 ...
 * @Class PKCS7Encoder
 * @Description:
 * @CreateDate: 2023/3/4 15:02
 * @UpdateDate: 2023/3/4 15:02 By 小刘
 */
class PKCS7Encoder
{
 ...
 * @Class Prpcrypt
 * @Description:
 * @CreateDate: 2023/3/4 15:00
 * @UpdateDate: 2023/3/4 15:00 By 小刘
 */
class Prpcrypt
{
    public $key;
